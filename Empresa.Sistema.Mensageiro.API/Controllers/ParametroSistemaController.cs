...
namespace Empresa.Sistema.Cadastro.API.Controllers
{
    ...
    public class ParametroSistemaController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("ObterQuery/{nome}")]
        public ActionResult<ParametroSistemaDTORetorno> ObterQuery(string nome)
        {
            log.Write("ObterAsync({0})", nome);
            ...
            try
            {
                return Ok(this.parametroApp.ObterQuery(nome));
            }
            catch (ArgumentException aEx)
            {
                return StatusCode((int)HttpStatusCode.InternalServerError, aEx.Message);
        ...
        [HttpGet]
        [Route("ObterQueryObjetoAgregado/{nome}")]
        public ActionResult<ParametroSistemaDTORetorno> ObterQueryComObjetoAgregado(string nome)
        {
            log.Write("ObterAsync({0})", nome);
            ...
            try
            {
                return Ok(this.parametroApp.ObterQueryComObjetoAgregado(nome));
            }
            catch (ArgumentException aEx)
            {
                return StatusCode((int)HttpStatusCode.InternalServerError, aEx.Message);
