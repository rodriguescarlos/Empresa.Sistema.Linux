...
namespace Empresa.Sistema.Cadastro.Application.Servico
{
    public class ParametroSistemaServicoApplication : IParametroSistemaApplication
    {
        ...
        public ParametroSistemaDTORetorno ObterQuery(string paramento)
        {
            var resultado = _service.ObterQuery(paramento);
            return _mapper.Map<ParametroSistemaDTORetorno>(resultado);
        }

        public ParametroSistema ObterQueryComObjetoAgregado(string nomeParamento)
        {
            return _service.ObterQueryComObjetoFilho(nomeParamento);
            //return _mapper.Map<ParametroSistemaDTORetorno>(resultado);
        }
