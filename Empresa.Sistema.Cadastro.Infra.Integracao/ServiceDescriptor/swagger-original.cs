...
namespace Empresa.Sistema.Cadastro.Infra.Integracao.ServiceDescriptor
{
    using Microsoft.Rest;
    using Models;

    /// <summary>
    /// Este e um servidor Petstore de amostra. Voc? pode descobrir mais sobre
    /// Swagger em [http://swagger.io](http://swagger.io) ou em
    /// [irc.freenode.net, #swagger](http://swagger.io/irc/).      Para este
    /// exemplo, voc? pode usar a chave da API `special-key` para testar os
    /// filtros de autoriza??o.
    /// </summary>
...
namespace Empresa.Sistema.Cadastro.Infra.Integracao.ServiceDescriptor.Models
{
    using System.Linq;
