...
namespace Empresa.Sistema.Cadastro.Domain.Service
{
    public class ParametroSistemaService : IParametroSistemaService
    {
        ...
        public ParametroSistema ObterQuery(string paramento)
        {
            return _repository.ObterQuery(paramento);
        }

        public ParametroSistema ObterQueryComObjetoFilho(string paramento)
        {
            return _repository.ObterQueryComObjetoFilho(paramento);
        }
